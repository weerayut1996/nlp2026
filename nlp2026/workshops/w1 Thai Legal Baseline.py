...
def legal_tokenizer(text): # Baseline_Tokenizer
...
# การวัดค่า ความกำกวม (Ambiguity Rate) เทียบระหว่าง Dictionary Base+Regex กับ "WangchanBERTa"
...
# ทดสอบการวัด กำกวม เน้นด้านกฎหมาย
def analyze_refined_amiguity(text,legal_keywords):
    ...
    # Ambiguity = Average Fragmentation - 1 แต่ถ้า ตัดพอดี เท่ากับ 0
